...
public class MailSender {
    ...
    //发件人邮箱
    private static String myEmailAccount = "625120603@qq.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "jttglgxvpcxjbfia";

    public static void main(String[] args) {
        try {
            sender("625120603@qq.com", "", "test");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public static void sender(String toEmailAddress, String emailTitle, String emailContent) throws Exception {
